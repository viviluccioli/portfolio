...
- 📊 **Machine Learning**: Supervised learning (regression and classification), unsupervised learning (PCA, t-SNE, k-Means, DBSCAN, Hierarchical clustering), reinforcement learning
- 📈 **Statistical Analysis**: Bayesian Statistics, Multivariate Regression, Time Series Analysis, Survival Analysis
- 🔍 **Data Processing**: Database Design, ETL Pipelines, Data Visualization, Tidy Data
- 📋 **Domain Expertise**: Epidemiological Analysis, Business Analytics
