...
<div class="hero-section">
  <div class="hero-content">
    ...
    <p class="welcome-message" id="welcome-message" style="margin-bottom: 2rem;">Welcome to my personal portfolio!</p>
    ...
    <div class="floating-symbols" id="floating-symbols">
      ...
      <img src="images/icons/hadoop.png" alt="Hadoop" class="float-symbol" data-delay="6">
      <img src="images/icons/graph.png" alt="Graph" class="float-symbol" data-delay="7">
      <img src="images/icons/tensor.svg" alt="Tensor" class="float-symbol" data-delay="8">
    ...
    <p class="hero-subtitle" style="font-size: clamp(1.1rem, 2.5vw, 1.5rem); margin-bottom: 1rem;">
      Here, you can learn more about me, see my <a href="resume.html" style="color: #f9bb81ff; text-decoration: underline;">resume</a>, and explore some of my <a href="projects.html" style="color: #7462be; text-decoration: underline;">projects</a>.
    </p>
...
<div class="bio-section">
  ...
  <div class="bio-text">
    ...
    <p>I am a second-year M.S. student in Georgetown University’s Data Science and Analytics program, graduating in May 2026. Alongside my studies, I serve as an AI Intern at the Federal Reserve Board of Governors in Washington, D.C., where I am an inaugural member of the Financial Stability Cyber and AI Sentinel Lab. I design and deploy AI systems that support economic research, including multi-agent research assistants, GraphRAG architectures over financial knowledge graphs, and time-series transformer models for financial stability analysis. I am also the first author of <em><a href="https://arxiv.org/pdf/2511.11574" target="_blank">
    LLM on a Budget
    </a></em> (IEEE Big Data 2025), introducing an active learning framework that reduces labeling costs by 80% while preserving model performance.</p>

    <p>I'm actively involved in my Georgetown community! I currently serve as a Professional Development Center assistant and was also aresearch assistant in Dr. Qiwei (Britt) He's AI Measurement and Development (AIMD) Lab and served as a teaching assistant for DSAN 6150: Biological and Biomedical Data Science.</p>

    <p>I also hold two B.A. degrees from the University of Virginia in Statistics (concentration in Biostatistics) and Global Public Health.</p>
  </div>
</div>
...
- Research:
  - [*LLM on a Budget: Active Knowledge Distillation for Efficient Classification of Large Text Corpora*](https://www.arxiv.org/pdf/2511.11574)
    - Published in IEEE Big Data 2025 and as a FEDS Notes paper 
    - In affiliation with Federal Reserve Board of Governors
  - Pending publication of research in collaboration with Georgetown Data Science & Analytics Program director Dr. Purna Gamage, stemming from a course group final [project](file:///Users/vivianaluccioli/Dropbox/personal/portfolio/_site/projects/dsan-5100/_site/index.html)
